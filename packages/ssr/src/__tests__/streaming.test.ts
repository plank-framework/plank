...
import { ProgressiveEnhancement, StreamingResponse, StreamingTemplates } from '../streaming.js';
...
describe('StreamingTemplates', () => {
  test('should generate document structure', () => {
    const html = StreamingTemplates.generateDocument('Test Page', '<h1>Hello</h1>', {
      lang: 'en',
      styles: ['/style.css'],
      scripts: ['/app.js'],
